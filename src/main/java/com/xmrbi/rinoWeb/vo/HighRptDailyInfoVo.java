...
public class HighRptDailyInfoVo {
    ...
    public void setTodayHighRptStation(List<HighRptStation> todayHighRptStation) {
        this.todayHighRptStation = todayHighRptStation;
    }

    public List<HighRptStation> getYesterdayHighRptStation() {
        return yesterdayHighRptStation;
    }

    public void setYesterdayHighRptStation(List<HighRptStation> yesterdayHighRptStation) {
